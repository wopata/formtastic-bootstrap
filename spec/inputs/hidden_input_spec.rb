...
describe 'hidden input' do
  ...
  it "should generate a input field" do
    output_buffer.should have_tag("form div div.input input#post_secret")
    output_buffer.should have_tag("form div div.input input#post_secret[@type=\"hidden\"]")
    output_buffer.should have_tag("form div div.input input#post_secret[@name=\"post[secret]\"]")
  end

  it "should get value from the object" do
    output_buffer.should have_tag("form div div.input input#post_secret[@type=\"hidden\"][@value=\"1\"]")
  end
  
  it "should pass any explicitly specified value - using :value" do
    output_buffer.should have_tag("form div div.input input#post_author_id[@type=\"hidden\"][@value=\"99\"]")
  end
  ...
  it "should pass any explicitly specified value - using :input_html options" do
    output_buffer.should have_tag("form div div.input input#post_published[@type=\"hidden\"][@value=\"true\"]")
  end

  it "should pass any option specified using :input_html" do
    output_buffer.should have_tag("form div div.input input#new_post_reviewer[@type=\"hidden\"][@class=\"new_post_reviewer\"]")
  end

  it "should prefer :input_html over directly supplied options" do
    output_buffer.should have_tag("form div div.input input#post_author_id[@type=\"hidden\"][@value=\"formtastic_value\"]")
  end
